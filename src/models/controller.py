...
class Controller(Controller):
    ...
    def __init__(self, sensor: TempSensor = TempSensor()):
        ...
        :param sensor: sensor, used for getting values for the controller, defaults to TempSensor()
    ...
    def perform_action(self) -> Dict[str, str]:
        """
        Read the value of the sensor, perform an appropriate action based on that.
